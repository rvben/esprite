...
// device-accurate: the button bezel reflects the declared physical buttons, and
// a hardware control strip (battery level, charging/USB toggles, rotate) appears
// only for the capabilities the board actually has. Only compiled when SDL2 is
// found; the CLI guards use of these on HAVE_SDL2.
...
// Request a PNG of the FULL window (screen + bezel + control strip), written on
